...
and validate its manifest, hashes, target, ABI version, exact revision, table size,
capability bits, and reserved fields. Build and exercise a native bundle with:

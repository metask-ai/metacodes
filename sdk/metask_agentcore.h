...
#define METASK_AGENTCORE_MAX_TOOL_COUNT_V1 UINT64_C(1024)
#define METASK_AGENTCORE_MAX_TOOL_SCHEMA_BYTES_V1 UINT64_C(1048576)
#define METASK_AGENTCORE_MAX_TOOL_SCHEMA_DEPTH_V1 32u
#define METASK_AGENTCORE_MAX_TOOL_SCHEMA_PROPERTIES_V1 UINT64_C(1024)
#define METASK_AGENTCORE_MAX_UI_RESPONSE_BYTES_V1 UINT64_C(1048576)
#define METASK_AGENTCORE_MAX_HOST_TOOL_RESULT_BYTES_V1 UINT64_C(16777216)
#define METASK_AGENTCORE_MAX_TOOL_ERROR_PAYLOAD_BYTES_V1 UINT64_C(1048576)
#define METASK_AGENTCORE_MAX_SESSION_ID_BYTES_V1 UINT64_C(64)
#define METASK_AGENTCORE_MAX_METADATA_STRING_BYTES_V1 UINT64_C(1048576)
#define METASK_AGENTCORE_MAX_RUNTIME_METADATA_BYTES_V1 UINT64_C(16777216)
#define METASK_AGENTCORE_MAX_SESSION_METADATA_BYTES_V1 UINT64_C(4194304)
...
#define METASK_AGENTCORE_CAP_RUNTIME (UINT64_C(1) << 0)
#define METASK_AGENTCORE_CAP_BUILTIN_TOOLS (UINT64_C(1) << 1)
#define METASK_AGENTCORE_CAP_HOST_SYNC_TOOLS (UINT64_C(1) << 2)
#define METASK_AGENTCORE_CAP_HOST_UI (UINT64_C(1) << 3)
#define METASK_AGENTCORE_CAP_CORE_EVENTS_JSON (UINT64_C(1) << 4)
#define METASK_AGENTCORE_CAP_ABORT (UINT64_C(1) << 5)

...
class ProceduralMemoryAdapterTest(unittest.TestCase):
    ...
    def adapt_value(self, root: Path, value: dict, *, limit_families=2):
    ...
    def test_source_hash_mismatch_and_invalid_selection_fail_before_outputs(self):
        ...
        with self.assertRaisesRegex(ValidationError, "requested 3 families"):
            select_families(load_fixture()["families"], limit_families=3, split_seed=1)

...
// ============================================================================
// 同步输出(DEC 2026)——把一帧的多条序列包成原子更新
// ============================================================================
// begin..end 之间的输出被终端缓冲、不逐条呈现,end 时一次性合成。消除"擦除→重画"
// 两步之间的中间空白帧闪烁(Windows Terminal 无同步标记时会即时逐块刷,故闪得明显;
// mac 终端合成掩盖了它)。不支持 2026 的终端会忽略这两个私有模式,退化为原逐条行为
// (无害)。参考:https://gist.github.com/christianparpart/d8a62cc1ab659194337d73e399004036

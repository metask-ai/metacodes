...
pub const TuiBackend = struct {
    ...
    fn emitImpl(self: *TuiBackend, ev: CoreEvent) void {
        switch (ev) {
            ...
            .diag_turn_begin, .diag_turn_end, .diag_model_request, .diag_compact_request, .diag_tool_stage, .diag_breaker_tripped, .diag_cache_break, .diag_continuation, .policy_decision, .diag_run_end => {},
        }
    }
